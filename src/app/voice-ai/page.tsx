...
export const metadata: Metadata = {
  title: "Integrated Voice AI Assistants — Calls, Booking, Support, and Sales",
  description:
    "Deploy all kinds of integrated voice assistants for clinics, home services, e-commerce, real estate, and support teams. Answer calls 24/7, qualify leads, schedule appointments, and sync every conversation to your tools.",
  openGraph: {
    title: "Integrated Voice AI Assistants — Calls, Booking, Support, and Sales",
    description:
      "Always-on assistants integrated with your stack for inbound calls, lead capture, booking, and support workflows.",
    url: "/voice-ai",
    type: "website",
  },
};
          ...
          <div className="flex h-[72px] items-center justify-between gap-4">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                ...
                <p className="text-[11px] text-slate-500">Voice AI</p>
              </div>
            </Link>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-fuchsia-600">
                Integrated Voice AI Assistants
              </p>
              <h1 className="mt-3 text-4xl sm:text-5xl font-bold tracking-tight">
                Voice AI for Calls, Booking, Lead Capture, and Support
              </h1>
              <p className="mt-5 text-slate-600 max-w-2xl">
                Launch integrated voice assistants across industries. Handle inbound calls, qualify
                leads, book appointments, route requests, and sync outcomes to CRM, WhatsApp, SMS,
                and your support stack while your team focuses on high-value work.
              </p>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
                  ...
                  <p className="mt-1 text-xs text-slate-500">Recover missed opportunities in minutes.</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-6">
              ...
              <p className="mt-3 text-slate-600">
                Hear how customers experience your AI assistant. Replace hold music with a warm
                voice that captures intent, routes requests, books appointments, and confirms details.
              </p>
            ...
            <div className="lg:col-span-6">
              <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-3 text-xs text-slate-500">
                  Demo video preview of the integrated voice assistant experience.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="pricing" className="py-16 scroll-mt-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-slate-600">
              Most teams land in the $599–$1,199/mo range depending on call volume, channels, and integrations.
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg">
              ...
              <ul className="mt-5 space-y-2 text-sm text-slate-600">
                ...
                <li>• Core flows: booking, FAQs, pricing basics, and lead capture</li>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg">
              ...
              <p className="mt-1 text-sm text-slate-600">Multi-location / multi-team operations</p>
      ...
      <section id="contact" className="py-16 bg-slate-50/60 scroll-mt-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5">
              <h2 className="text-3xl font-bold text-slate-900">
                Ready to capture every inbound call?
              </h2>
              <p className="mt-3 text-slate-600">
                Share a few details and we will walk you through a live demo tailored to your business
                flows, channels, and routing rules.
              </p>
            ...
            >
              ...
              <input type="hidden" name="service" value="voice_ai_demo" />
              ...
              <label className="grid gap-1 text-sm">
                ...
                <textarea
                  ...
                  placeholder="What do you want your voice assistant to improve?"
                  name="message"
                />
              </label>
